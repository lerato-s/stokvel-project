...
const GroupSchema = new mongoose.Schema(
  {
    ...
    freq: { type: String, required: true },             // Contribution frequency (e.g., "monthly")
    cycle: { type: String, required: true },            // Payout cycle description
    max: { type: Number, required: true },              // Maximum number of members
    meetFreq: { type: String, required: true },         // Meeting frequency (e.g., "weekly")
    meetDay: { type: String, required: true },          // Day of meeting (e.g., "Friday")
    meetWeek: { type: String, required: true },         // Week of meeting (e.g., "last")
    payoutMethod: { type: String, required: true },     // Payment method (EFT, cash, etc.)
    rules: { type: String, required: true },            // Group rules text
